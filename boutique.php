        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
          <div class="col-first">
            ...
            <nav class="d-flex align-items-center">
              ...
              <a href="boutique.php">Boutique Products</a>
            </nav>
          </div>
        </div>
      </div>
        ...
        <!-- Start Best Seller -->
				...
				<section class="lattest-product-area pb-40 category-list" style="padding: 10px;" id="hide">
					<div class="row">
                        <?php
                            $results_per_page = 12;
                            $sql = "SELECT * FROM products WHERE category='boutique';";
                            ...
                            $sql = "SELECT * FROM products WHERE category='boutique' LIMIT " . $this_page_first_result . "," . $results_per_page;
                            $result = mysqli_query($conn, $sql);
                        ...
                        <div class="pagination text-center">
                            <?php 
                                for($page=1;$page<=$number_of_pages;$page++) {
                                    echo '<a href="boutique.php?page='. $page . '">' .$page . '</a>';
                                }
                            ?>
                        </div>
				    </div>
