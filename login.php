...
<body>
	...
	<section class="login_box_area section_gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img col-lg-10 col-md-5 col-12">
						<img class="img-fluid" src="img/login.jpg" style="">
						<div class="hover">
							<h4>Don't have an account with us yet?</h4>
							<p>Shop wisely with Smart Drops Supermarket & Boutique now!!!</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="login.inc.php" method="post">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="submit" id="submit" class="primary-btn">Sign In</button>
							</div>
						</form>
					</div>
				</div>
