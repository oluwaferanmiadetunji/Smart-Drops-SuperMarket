...
<body>
	...
	<section class="login_box_area section_gap">
		<div class="container">
				...
				<div class="col-lg-6">
					<div class="login_box_img col-lg-10 col-md-5 col-12">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="login.php">Start Shopping</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <h3>Sign Up</h3>
						<form class="row login_form" action="signup.inc.php" method="post">
							<div class="col-md-12 form-group">
								<input type="name" class="form-control" id="name" name="name" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" required>
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="submit" id="submit" class="primary-btn">Sign Up</button>
							</div>
						</form>
					</div>
				</div>
