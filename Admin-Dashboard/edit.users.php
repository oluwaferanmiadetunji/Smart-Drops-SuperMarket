                    ...
                    <div class="p-5">
						...
						<div class="bootstrap-iso">
	                        <form class="user" action="utilities/user.edit.php" method="POST">
	                            ...
	                            <div class="form-group row">
	                                <label for="state" class="col-sm-2 col-form-label form_label">State</label>
	                                <div class="col-sm-8">
	                                    <input type="text" class="form-control form-control-user" value="<?php echo $state; ?>" name="state" id="register-state">
	                                </div>
	                            </div>
